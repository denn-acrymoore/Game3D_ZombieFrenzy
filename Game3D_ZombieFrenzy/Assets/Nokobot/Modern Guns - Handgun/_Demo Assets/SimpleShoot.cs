...
public class SimpleShoot : MonoBehaviour
{
    ...
    [Tooltip("Casing Ejection Speed")] [SerializeField] private float ejectPower = 300f;
    ...
    void Shoot()
    {
        ...
        {
            muzzleFlashParticle.GetComponent<ParticleSystem>().Clear();
    ...
    void CasingRelease()
    {
        ...
        tempCasing.transform.parent = transform;
